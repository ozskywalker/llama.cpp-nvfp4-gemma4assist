...
enum llm_kv {
    ...
    LLM_KV_ATTENTION_K_EQ_V,

    // gemma4_assistant (speculative draft head)
    LLM_KV_N_CENTROIDS,
    LLM_KV_CENTROID_TOP_K,
    LLM_KV_N_EMBD_BACKBONE,
    LLM_KV_USE_ORDERED_EMBEDDINGS,
    LLM_KV_REQUIRES_TARGET_ARCH,
...
enum llm_tensor {
    ...
    LLM_TENSOR_MTP_PRE_PROJ,        // gemma4_assistant
    LLM_TENSOR_MTP_POST_PROJ,       // gemma4_assistant
    LLM_TENSOR_MTP_CENTROIDS,       // gemma4_assistant
    LLM_TENSOR_MTP_TOKEN_ORDERING,  // gemma4_assistant
