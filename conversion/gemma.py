...
# Upstream's dedicated class for the Gemma4Unified backbone (adds suppress_tokens). We previously
# registered this arch string on Gemma4Model (88a1ae171); now defer to this class and drop it from
# the Gemma4Model decorator to avoid a double registration.
